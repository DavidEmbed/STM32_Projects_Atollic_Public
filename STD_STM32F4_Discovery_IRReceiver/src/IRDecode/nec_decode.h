...
#define	T_PULSE				600		// IR burst length
#define T_ZERO_SPACE		600		// space after IR burst during bit 0
#define T_ONE_SPACE			1800	// space after IR burst during bit 1

#define T_TOLERANCE			0.25f	// 25% timing tolerance
#define EXTENDED			0		// extended:16 bit address no complement, not extended:8 bit address with complement
